...
const takeOutOrders: Array<number> = [17, 8, 24];
const dineInOrders: Array<number> = [12, 19, 2];
let servedOrders: Array<number> = [17, 8, 12, 19, 24, 2];
...
const orderChecker = (takeOutOrders: Array<number>, dineInOrders: Array<number>, servedOrders: Array<number>) => {
  let answer: boolean = true;
  servedOrders.forEach( (order: number) => {
